...
// --- API Function 1: Agent ID (unchanged from your file) ---
...
// --- API Function 2: Log Time (unchanged from your file) ---
...
// --- API Function 3: Update Status (unchanged from your file) ---
...
// --- API Function 4: Add Note (unchanged from your file) ---
...
// --- Error Handler (unchanged from your file) ---
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  elements = {
    ...
    addAsNoteCheck: document.getElementById("add-as-note-check"), // New element
  ...
  chrome.storage.sync.get(configDefaults, (config) => {
    ...
    elements.statusFieldset.disabled = true;
    elements.doUpdateStatus.checked = false;
  });
  ...
  elements.submitBtn.addEventListener("click", async () => {
    ...
    try {
      ...
      // --- 2. Basic config validation (unchanged) ---
      let missing = [];
      ...
      const doAddNote = elements.addAsNoteCheck.checked; // Use new checkbox
      ...
      // --- 5. Get Agent ID & Ticket ID (unchanged) ---
